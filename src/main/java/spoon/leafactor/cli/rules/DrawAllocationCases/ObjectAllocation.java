package spoon.leafactor.cli.rules.DrawAllocationCases;

import spoon.leafactor.cli.engine.CaseOfInterest;
import spoon.leafactor.cli.engine.DetectionPhaseContext;
